 ...
 * @author Hang Xu
 */
public class MessageOnFirdgeGUI extends javax.swing.JFrame {

    /**
     * Creates new form MessageOnFirdegGUI
     */
    public MessageOnFirdgeGUI() {
        initComponents();
        fridgeText.setText(MOF.getMOF());
    }
    ...
    private void sendButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendButtonActionPerformed
        ...
        String f = ID.getName()+" says:"+noteText.getText()+"\n";
        MOF.addMessage(f);
        fridgeText.setText(MOF.getMOF());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MessageOnFirdgeGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MessageOnFirdgeGUI().setVisible(true);
            }
        });
    }
