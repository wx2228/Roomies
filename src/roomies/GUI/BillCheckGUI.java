  ...
  DefaultTableModel model;
   ...
   public void billLoading()
    {   
       ...
       for(int i=0;i<ExistingBill.count();i++)
       {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Lily Aldrin should pay:");

        jLabel3.setText("Marshall Eriksen should pay:");

        JLabel1.setText("Ted Mosby should pay:");
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
         ...
         {
             Wrong noSelected = new Wrong();
             noSelected.setText("Choose a bill first");
        ...
        if(a.length>1)
        {
            Wrong mutdelete = new Wrong();
            mutdelete.setText("Once at a time,please");
        ...
        Object[] tmp = editedBill.getValue();
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        DeleteWindow.setIndex(displayTable.getSelectedRow());
        del.setVisible(true);
       }
    ...
    private void todayButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_todayButtonActionPerformed
        ...
        int[] selected = new int[ExistingBill.count()];
        for(int i=0;i<ExistingBill.count();i++)
        {
            selected[i]=-1;
        }
        ...
        {
             Wrong noSelected = new Wrong();
             noSelected.setText("no bill for today");
             noSelected.setVisible(true);
             return;
        }
    ...
    private void thisMonthButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_thisMonthButtonActionPerformed
        ...
        {
             Wrong noSelected = new Wrong();
             noSelected.setText("no bill for this month");
             noSelected.setVisible(true);
             return;
        }
        double[] calculatedAmounts = ExistingBill.split(selected);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BillCheckGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BillCheckGUI().setVisible(true);
            }
        });
    }
